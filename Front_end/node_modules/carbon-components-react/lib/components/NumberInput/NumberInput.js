  ...
  _createClass(NumberInput, [{
    ...
    value: function render() {
      ...
      var _this$props3 = this.props,
          ...
          other = _objectWithoutProperties(_this$props3, ["className", "disabled", "iconDescription", "id", "hideLabel", "label", "max", "min", "step", "value", "readOnly", "invalid", "invalidText", "warn", "warnText", "helperText", "ariaLabel", "light", "allowEmpty", "innerRef", "translateWithId", "isMobile", "size"]);
      ...
      var labelClasses = (0, _classnames.default)("".concat(prefix, "--label"), (_classNames3 = {}, _defineProperty(_classNames3, "".concat(prefix, "--label--disabled"), disabled), _defineProperty(_classNames3, "".concat(prefix, "--visually-hidden"), hideLabel), _classNames3));
      ...
      var wrapperClasses = (0, _classnames.default)("".concat(prefix, "--number__input-wrapper"), _defineProperty({}, "".concat(prefix, "--number__input-wrapper--warning"), !isInputInvalid && warn));
      return /*#__PURE__*/_react.default.createElement("div", {
        ...
        }), !isInputInvalid && warn && /*#__PURE__*/_react.default.createElement(_iconsReact.WarningAltFilled16, {
