...
var FilterableMultiSelect = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(FilterableMultiSelect, [{
    ...
    value: function render() {
      ...
      var inputClasses = (0, _classnames.default)("".concat(prefix, "--text-input"), (_cx4 = {}, _defineProperty(_cx4, "".concat(prefix, "--text-input--empty"), !this.state.inputValue), _defineProperty(_cx4, "".concat(prefix, "--text-input--light"), light), _cx4));
