...
var Tooltip = /*#__PURE__*/function (_Component) {
  ...
  function Tooltip(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "_tooltipId", _this.props.tooltipId || "__carbon-tooltip_".concat(Math.random().toString(36).substr(2)));
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var _this$props = this.props,
          ...
          other = _objectWithoutProperties(_this$props, ["triggerId", "tooltipBodyId", "children", "className", "triggerClassName", "direction", "focusTrap", "triggerText", "showIcon", "iconName", "iconDescription", "renderIcon", "menuOffset", "tabIndex", "innerRef", "selectorPrimaryFocus"]);
      ...
      return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(_ClickListener.default, {
        ...
        ref: refProp
      }), /*#__PURE__*/_react.default.createElement(IconCustomElement, iconProperties))) : /*#__PURE__*/_react.default.createElement("div", _extends({
        id: triggerId,
        className: triggerClasses,
        ref: refProp
