...
ModalBody.propTypes = (_ModalBody$propTypes = {}, _defineProperty(_ModalBody$propTypes, 'aria-label', (0, _requiredIfGivenPropIsTruthy.default)('hasScrollingContent', _propTypes.default.string)), _defineProperty(_ModalBody$propTypes, "children", _propTypes.default.node), _defineProperty(_ModalBody$propTypes, "className", _propTypes.default.string), _defineProperty(_ModalBody$propTypes, "hasForm", _propTypes.default.bool), _defineProperty(_ModalBody$propTypes, "hasScrollingContent", _propTypes.default.bool), _ModalBody$propTypes);
...
var ModalFooter = /*#__PURE__*/function (_Component3) {
  ...
  _createClass(ModalFooter, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/_react.default.createElement(_ButtonSet.default, _extends({
