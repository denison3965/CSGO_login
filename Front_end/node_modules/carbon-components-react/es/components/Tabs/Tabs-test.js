  ...
  describe('renders as expected', function () {
    describe('navigation (<div>)', function () {
      ...
      it('renders [role="navigation"] props on wrapping <div> by default', function () {
        ...
        .find(".".concat(prefix, "--tabs--scrollable .").concat(prefix, "--tabs--scrollable")).props().role).toEqual('navigation');
      });
      ...
      it('renders extra classes on wrapping <div> via className prop', function () {
        ...
        .find(".".concat(prefix, "--tabs--scrollable .").concat(prefix, "--tabs--scrollable")).hasClass('extra-class')).toBe(true);
      });
      ...
      it('supports container variant', function () {
        expect(shallow( /*#__PURE__*/React.createElement(Tabs, {
          ...
          label: "lastTab"
        }, "content2"))).find('div') // TODO: uncomment and replace .at() in next major version
        // .first()
        .at(1).hasClass("".concat(prefix, "--tabs--scrollable--container"))).toBe(true);
      });
      it('has no selectionMode prop', function () {
        expect('selectionMode' in wrapper // TODO: uncomment in next major version
        // .find(`.${prefix}--tabs`)
        .find(".".concat(prefix, "--tabs--scrollable .").concat(prefix, "--tabs--scrollable")).props()).toBe(false);
      });
    });
