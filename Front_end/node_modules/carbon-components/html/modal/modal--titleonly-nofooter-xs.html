...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-ik6v8x7sidi">Show
  modal</button>

<div data-modal id="modal-ik6v8x7sidi" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-ik6v8x7sidi-label" aria-describedby="modal-ik6v8x7sidi-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-ik6v8x7sidi-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-ik6v8x7sidi-heading">Passive modal title as the message. Should be direct and 3 lines or less.</p>
