...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-eks6h4ya69e">Show
  modal</button>

<div data-modal id="modal-eks6h4ya69e" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-eks6h4ya69e-label" aria-describedby="modal-eks6h4ya69e-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-eks6h4ya69e-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-eks6h4ya69e-heading">Modal heading</p>
