...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-r0g6dbz6o2d">Show
  modal</button>

<div data-modal id="modal-r0g6dbz6o2d" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-r0g6dbz6o2d-label" aria-describedby="modal-r0g6dbz6o2d-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-r0g6dbz6o2d-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-r0g6dbz6o2d-heading">Modal heading</p>
