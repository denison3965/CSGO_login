...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-t3w4lb401if">Show
  modal</button>

<div data-modal id="modal-t3w4lb401if" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-t3w4lb401if-label" aria-describedby="modal-t3w4lb401if-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-t3w4lb401if-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-t3w4lb401if-heading">Modal heading</p>
