...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1cs00q9vc15">Show
  modal</button>

<div data-modal id="modal-1cs00q9vc15" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1cs00q9vc15-label" aria-describedby="modal-1cs00q9vc15-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1cs00q9vc15-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1cs00q9vc15-heading">Modal heading</p>
