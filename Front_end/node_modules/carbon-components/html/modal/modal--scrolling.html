...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-kx7w3o62d8n">Show
  modal</button>

<div data-modal id="modal-kx7w3o62d8n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-kx7w3o62d8n-label" aria-describedby="modal-kx7w3o62d8n-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-kx7w3o62d8n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-kx7w3o62d8n-heading">Modal heading</p>
