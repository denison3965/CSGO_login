...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-2ps3iow40hd">Show
  modal</button>

<div data-modal id="modal-2ps3iow40hd" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-2ps3iow40hd-label" aria-describedby="modal-2ps3iow40hd-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-2ps3iow40hd-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-2ps3iow40hd-heading">Modal heading</p>
