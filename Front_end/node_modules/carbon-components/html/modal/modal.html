...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-4yd2o1ynmot">Show
  modal</button>

<div data-modal id="modal-4yd2o1ynmot" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-4yd2o1ynmot-label" aria-describedby="modal-4yd2o1ynmot-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-4yd2o1ynmot-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-4yd2o1ynmot-heading">Modal heading</p>
