...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-i4n57w7d02">Show
  modal</button>

<div data-modal id="modal-i4n57w7d02" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-i4n57w7d02-label" aria-describedby="modal-i4n57w7d02-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-i4n57w7d02-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-i4n57w7d02-heading">Modal heading</p>
